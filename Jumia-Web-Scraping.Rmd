...
## web scraping
-We start by getting thewebsite url and reading getting its contents
```{r}
...
new_page = read_html("https://www.jumia.co.ke/mlp-top-deals/?page=7#catalog-listing")
...
-After scraping the items, we clean the data snd store it in csv format.
```{r}
